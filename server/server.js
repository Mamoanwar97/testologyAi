...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DFtRs-Uy.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BW4Bv_jw.js").then((n) => n.r);
...
const ROUTER_BASEPATH = "testologyAi";
const SERVER_FN_BASE = "/testologyAi/_serverFn/";
