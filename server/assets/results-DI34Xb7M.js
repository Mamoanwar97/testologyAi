...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxs("main", { className: "flex min-h-[60vh] flex-col items-center justify-center px-4 py-16 text-center", children: [
    ...
    /* @__PURE__ */ jsx("h1", { className: "mb-2 text-2xl font-bold text-foreground", children: "Chapter not found" }),
    /* @__PURE__ */ jsx("p", { className: "mb-6 text-muted-foreground", children: "This chapter doesn't exist. Let's get you back on track." }),
